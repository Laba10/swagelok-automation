...
public class HeaderPageElements {
    ...
    public static final By QUICK_ORDER_FORM_BUTTON_XPATH = By.xpath("//div/a[contains(text(),'Quick Add Form')]");
    ...
    public static final By ERROR_MESSAGE_IN_FORM_PART_NUMBER = By.xpath("//div[@id='part-error_m_']");
    ...
    public static final By SEARCH_FIELD_XPATH = By.xpath("//input[@id='js-adaptive-site-search-input']");
